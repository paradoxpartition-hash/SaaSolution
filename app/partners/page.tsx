...
const projectTypes = ["Web Platform", "Mobile App", "AI Agent", "Hardware + Web", "Design System", "Other"];
const budgets = ["< $10k", "$10k - $50k", "$50k - $150k", "$150k+"];
const steps = [
  { title: "Discovery call", body: "30 min, free, no pitch" },
  { title: "Proposal", body: "Scoped and priced in 5 business days" },
  { title: "Kickoff", body: "Weekly demos from week one" }
];
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
            <section aria-labelledby="partner-title" className="lg:sticky lg:top-10">
              <p className="text-xs font-bold uppercase tracking-[0.42em] text-[#FBBF24]">- Start a project</p>
              <h1 id="partner-title" className="mt-7 max-w-xl text-5xl font-bold leading-[0.98] tracking-tight md:text-7xl">
                Let&apos;s build something <span className="italic text-[#FBBF24]">worth talking about.</span>
              </h1>
              <p className="mt-8 max-w-lg text-lg font-semibold leading-8 text-[#F8F1E7]/76">
                Tell us about the product you have in mind. You&apos;ll hear back from a founder, not a sales bot, within one business day.
              </p>
              ...
              <aside className="mt-12 rounded-2xl border border-[#F8F1E7]/14 bg-[#173F3A]/72 p-6 shadow-[0_30px_100px_rgba(20,184,166,0.18)] backdrop-blur">
                ...
                <p className="mt-5 text-sm font-semibold leading-6 text-[#F8F1E7]/84">
                  One sharp email a month. Product launches, experiments, and tools we can&apos;t stop using. No fluff.
                </p>
                <form action="mailto:SLsaasolution@gmail.com" className="mt-6 grid gap-3 sm:grid-cols-[1fr_auto]" encType="text/plain" method="post">
                  ...
                  <input className="h-12 rounded-full border border-[#F8F1E7]/16 bg-[#10211F]/82 px-5 text-sm text-[#F8F1E7] outline-none transition placeholder:text-[#F8F1E7]/38 focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/30" id="newsletter-email" name="newsletter_email" placeholder="you@company.com" type="email" />
            ...
            <section aria-labelledby="project-form-title" className="rounded-[28px] border border-[#F8F1E7]/14 bg-[#F8F1E7]/[0.075] p-6 shadow-[0_40px_140px_rgba(0,0,0,0.38)] backdrop-blur-xl md:p-10">
              <h2 id="project-form-title" className="sr-only">Start a project form</h2>
              <form action="mailto:SLsaasolution@gmail.com" className="grid gap-7" encType="text/plain" method="post">
                <div className="grid gap-6 md:grid-cols-2">
                  <label className="grid gap-3">
                    <span className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Your name</span>
                  ...
                  <label className="grid gap-3">
                    <span className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Work email</span>
                ...
                <label className="grid gap-3">
                  <span className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Company (optional)</span>
                ...
                <fieldset>
                  <legend className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Project type</legend>
                ...
                <fieldset>
                  <legend className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Budget (optional)</legend>
                  <div className="mt-4 flex flex-wrap gap-3">
                    {budgets.map((budget) => (
                ...
                <label className="grid gap-3">
                  <span className="text-[10px] font-bold uppercase tracking-[0.35em] text-[#F8F1E7]/54">Tell us about it</span>
                  <textarea className="min-h-40 rounded-xl border border-[#F8F1E7]/16 bg-[#10211F]/76 px-5 py-5 text-base text-[#F8F1E7] outline-none transition placeholder:text-[#F8F1E7]/34 focus:border-[#F59E0B] focus:ring-2 focus:ring-[#F59E0B]/28" name="message" placeholder="What are you building? Who is it for? What's the deadline?" required />
                </label>
